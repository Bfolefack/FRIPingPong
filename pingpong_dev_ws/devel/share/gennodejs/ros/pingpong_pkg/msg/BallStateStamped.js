...
class BallStateStamped {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new BallStateStamped(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new BallStateStamped(null);
...
module.exports = BallStateStamped;
