...
(cl:in-package pingpong_pkg-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <BallStateStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BallStateStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pingpong_pkg-msg:<BallStateStamped> is deprecated: use pingpong_pkg-msg:BallStateStamped instead.")))

(cl:ensure-generic-function 'Header-val :lambda-list '(m))
(cl:defmethod Header-val ((m <BallStateStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pingpong_pkg-msg:Header-val is deprecated.  Use pingpong_pkg-msg:Header instead.")
  (Header m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <BallStateStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pingpong_pkg-msg:position-val is deprecated.  Use pingpong_pkg-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <BallStateStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pingpong_pkg-msg:velocity-val is deprecated.  Use pingpong_pkg-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'angular_velocity-val :lambda-list '(m))
(cl:defmethod angular_velocity-val ((m <BallStateStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pingpong_pkg-msg:angular_velocity-val is deprecated.  Use pingpong_pkg-msg:angular_velocity instead.")
  (angular_velocity m))
